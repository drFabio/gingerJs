...
ControllerBootstrap.prototype.init = function(engine,params) {
	this._engine=engine;
	this._params=params;
...
ControllerBootstrap.prototype.getActionsMap=function(controllerData){
	var actionsMap={};
...
ControllerBootstrap.prototype.getActionPlainName=function(name){
